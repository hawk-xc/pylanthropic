...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form action="{{ route('adm.donatur.store') }}" method="post" accept-charset="utf-8" class="row gy-3">
                @csrf
                <div class="col-12">
                    ...
                    <input type="text" class="form-control form-control-sm" name="name" id="donatur_name" required
                        placeholder="Masukkan nama donatur" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="col-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="want_to_contact" id="want_to_contact"
                            value="1" checked={{ old('want_to_contact') }}>
