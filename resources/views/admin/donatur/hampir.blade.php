@extends('layouts.admin', [
    'second_title'    => 'Donatur Hampir',
    'header_title'    => 'Donatur Hampir (belum pernah dibayar)',
    'sidebar_menu'    => 'person',
    'sidebar_submenu' => 'donatur_hampir'
])
                ...
                <div class="col-5">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 pb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Donatur Hampir</li>
                        </ol>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    var table = $('#table-donatur').DataTable({
        ...
        responsive: true,
        order: [],
        ajax: "{{ route('adm.donatur.hampir.datatables') }}",
        columns: [
            {data: 'name', name: 'name'},
