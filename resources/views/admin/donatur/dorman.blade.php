@extends('layouts.admin', [
    'second_title'    => 'Donatur Dorman',
    'header_title'    => 'Donatur Dorman',
    'sidebar_menu'    => 'person',
    'sidebar_submenu' => 'donatur_dorman'
])
                ...
                <div class="col-5">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 pb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Donatur Dorman</li>
                        </ol>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    var table = $('#table-donatur').DataTable({
        ...
        responsive: true,
        order: [],
        ajax: "{{ route('adm.donatur.dorman.datatables') }}",
        columns: [
            {data: 'name', name: 'name'},
