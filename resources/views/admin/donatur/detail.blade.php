            ...
            <table class="table table-hover table-striped table-bordered">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $donatur->telp }} 
                            {!! (is_null($donatur->wa)) ? '<span class="badge badge-success badge-sm">Aktif</span>' : '<span class="badge badge-danger badge-sm">Tidak Aktif</span>'; !!} 
                            {!! ($donatur->want_to_contact==1) ? '<span class="badge badge-success badge-sm">MAU</span>' : '<span class="badge badge-danger badge-sm">Jangan Dihubungi</span>'; !!}
                        </td>
                    </tr>
                    <tr>
                        <th>Email</th>
                    ...
                    <tr>
                        ...
                        <td>Rp.{{ number_format($sum_donate_all, 0, ',', '.') }} ({{ number_format($count_donate_all, 0, ',', '.') }})</td>
                    </tr>
                    <tr>
                        <th>Jumlah Donasi Dibayar</th>
                        <td>Rp.{{ number_format($sum_donate_paid, 0, ',', '.') }} ({{ number_format($count_donate_paid, 0, ',', '.') }})</td>
                    </tr>
                    <tr>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-10 fc-rtl">
                    <button class="btn btn-outline-primary mr-1" id="refresh_table_donate4"><i class="fa fa-sync"></i> Refresh</button>
                    <button class="btn btn-primary" id="filter-54"><i class="fa fa-plus mr-1" id="filter-54-icon"></i> Tambah</button>
                </div>
            </div>
            <!-- <div class="divider"></div>
            <div class="row">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-10 fc-rtl">
                    ...
                    <button class="btn btn-outline-primary" id="filter-5day"><i class="fa fa-check mr-1" id="filter-5day-icon"></i> Show 5 Hari</button>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-9 fc-rtl">
                    <button class="btn btn-outline-primary filter_payment" id="filter-bni" data-id="bni">Seminggu</button>
                    <button class="btn btn-outline-primary filter_payment" id="filter-bsi" data-id="bsi">Sebulan</button>
                    <button class="btn btn-outline-primary filter_payment" id="filter-bsi" data-id="bsi">Setahun</button>
                    <button class="btn btn-outline-primary filter_payment" id="filter-bsi" data-id="bsi">Islami</button>
            ...
            <div class="row">
                <div class="col-12 form-inline">
                    <span>Filter :</span>
                    <input type="text" id="program_title" placeholder="Judul Program" class="form-control form-control-sm me-1 ms-2"> 
                    <input type="text" id="donatur_telp" placeholder="Dari/Ke Telp ex: 8574..." class="form-control form-control-sm me-1"> 
                    <input type="text" id="filter_nominal" placeholder="Isi Chat" class="form-control form-control-sm me-1"> 
                    <input type="text" id="donatur_title" placeholder="Keterangan" class="form-control form-control-sm me-1">
                    <button class="btn btn-sm btn-primary" id="filter_search">Cari</button>
    ...
    <div class="main-card mb-3 mt-3 card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-10 fc-rtl">
                    <button class="btn btn-outline-primary filter_payment" id="filter-bni" data-id="bni">Masuk</button>
                    <button class="btn btn-outline-primary filter_payment" id="filter-bsi" data-id="bsi">Keluar</button>
                    <button class="btn btn-primary" id="filter-5day"><i class="fa fa-check mr-1" id="filter-5day-icon"></i> Show 5 Hari</button>
                    <button class="btn btn-outline-primary mr-1" id="refresh_table_donate"><i class="fa fa-sync"></i> Refresh</button>
                </div>
            </div>
...
<script type="text/javascript">    
    ...
    function donate_table() {
        ...
        table.ajax.url("{{ route('adm.donate.datatables') }}/?donatur_id={{$donatur->id}}&need_fu="+need_fu_ar+"&day1="+day1_ar+"&day5="+day5_ar+"&bni="+bni_ar+"&bsi="+bsi_ar+"&bri="+bri_ar+"&qris="+qris_ar+"&gopay="+gopay_ar+"&mandiri="+mandiri_ar+"&donatur_name="+encodeURI(donatur_name)+"&donatur_telp="+donatur_telp+"&filter_nominal="+filter_nominal+"&donatur_title="+encodeURI(donatur_title)).load();
    }
    ...
    var table = $('#table-donatur').DataTable({
        ...
        responsive: true,
        order: [[4, 'desc']],
        ajax: "{{ route('adm.donate.datatables') }}/?donatur_id={{$donatur->id}}&need_fu=="+need_fu+"&day1="+day1+"&day5="+day5,
        "columnDefs": [
            { "width": "21%", "targets": 0 },
            { "width": "14%", "targets": 1 },
            { "width": "35%", "targets": 2 },
    ...
    var table_program = $('#table-donatur-program').DataTable({
        ...
        responsive: true,
        order: [[4, 'desc']],
        ajax: "{{ route('adm.donatur.program.datatables') }}/?donatur_id={{$donatur->id}}&need_fu=="+need_fu+"&day1="+day1+"&day5="+day5,
        "columnDefs": [
            { "width": "23%", "targets": 0 },
            { "width": "15%", "targets": 1 },
            { "width": "15%", "targets": 2 },
    ...
    var table_chat = $('#table-donatur-chat').DataTable({
        ...
        responsive: true,
        order: [[4, 'desc']],
        ajax: "{{ route('adm.donatur.chat.datatables') }}/?donatur_id={{$donatur->id}}&need_fu=="+need_fu+"&day1="+day1+"&day5="+day5,
        "columnDefs": [
            { "width": "15%", "targets": 0 },
            { "width": "48%", "targets": 1 },
            { "width": "15%", "targets": 2 },
