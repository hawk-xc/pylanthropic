@extends('layouts.admin', [
    'second_title'    => 'Donatur Sultan',
    'header_title'    => 'Donatur Sultan (500rb keatas)',
    'sidebar_menu'    => 'person',
    'sidebar_submenu' => 'donatur_sultan'
])
                ...
                <div class="col-5">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 pb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Donatur Sultan</li>
                        </ol>
                    </nav>
                </div>
