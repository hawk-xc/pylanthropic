...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form action="{{ route('adm.shorten-link.update', $data->id) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control form-control-sm" name="name" placeholder="Nama URL/Link" value="{{ old('name', $data->name) }}"
                        required>
                    @error('name')
                        <div text-danger small mt-1"><i class="ri-error-warning-line"></i> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control form-control-sm" name="description" row="6" placeholder="Keterangan/Deskripsi">{{ old('description', $data->description) }}</textarea>
                    @error('description')
                            <div class="text-danger small mt-1"><i class="ri-error-warning-line"></i> {{ $message }}
                            </div>
                        @enderror
                ...
                <div class="col-4">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" {{ old('is_active', $data->is_active) ? 'checked' : '' }}>
