...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form action="{{ route('adm.program.update', $program->id) }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" class="row gy-3">
                @csrf
                @method('PUT')
                <div class="col-12">
                    <label class="form-label fw-semibold">Judul Program (max 75 karakter) - <span id="count_title" class="fw-normal"></span></label>
                    <input type="text" class="form-control form-control-sm" name="title" id="program_title" value="{{ $program->title }}" required>
                </div>
                <div class="col-12">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control" name="url" placeholder="bangunmasjidmandangin" id="url" value="{{ $program->slug }}" readonly>
                ...
                <div class="col-6">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control" name="nominal" id="rupiah" placeholder="100.000.000" value="{{ str_replace(',', '.', number_format($program->nominal_approved)) }}" required>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="date" class="form-control form-control-sm" id="forever" min="{{ date('Y-m-d') }}" name="date_end" value="{{ date('Y-m-d', strtotime($program->end_date)) }}" required>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        {{ ($program->is_show_home==1) ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        {{ ($program->is_recommended==1) ? 'checked' : ''}}>
                        <label class="form-check-label" for="tampil_terbaru">Terbaru</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" name="show" type="radio" id="tampil_mendesak" value="5" 
                        {{ ($program->is_urgent==1) ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        {{ ($program->is_publish==1 && $program->is_recommended==0 && $program->is_show_home==0 && $program->is_urgent==0) ? 'checked' : ''}}>
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control form-control-sm" name="caption" placeholder="Yuk bantu warga desa Meranti untuk memiliki masjid satu-satunya." value="{{ $program->short_desc }}" required>
                </div>
                ...
                <div class="col-6">
                    ...
                    @if(isset($program->thumbnail) && $program->thumbnail!='')
                        <img src="{{ asset('public/images/program/'.$program->thumbnail) }}" class="mt-2 img-preview">
                    @else
                ...
                <div class="col-6">
                    ...
                    @if(isset($program->image) && $program->image!='')
                        <img src="{{ asset('public/images/program/'.$program->image) }}" class="mt-2 img-preview">
                    @else
