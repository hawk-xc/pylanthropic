                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select @error('pipeline') is-invalid @enderror" name="pipeline" id="pipeline" required>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            initializeSelect2('#donatur-select2', 'Cari Donatur...',
                "{{ route('adm.donatur.select2.all') }}",
                item => `${item.name} (${item.telp})`);

            initializeSelect2('#users-select2', 'Cari PIC...',
            ...
            $('#prospect-form').on('reset', function() {
                $('#donatur-select2').val(null).trigger('change');
