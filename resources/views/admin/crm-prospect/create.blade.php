...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form action="{{ route('adm.crm-prospect.store') }}" method="post" accept-charset="utf-8" class="row gy-3">
                @csrf
                <div class="col-12">
                    <label class="form-label">Nama Prospect</label>
                    <input type="text" class="form-control" name="name" id="name"
                        placeholder="Masukkan Nama Prospect" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="col-12">
                    ...
                    <select class="form-control form-control-sm" name="donatur" id="donatur-select2" required></select>
                    @error('donatur')
                ...
                <div class="col-12">
                    ...
                    <select class="form-control form-control-sm" name="assign_to" id="users-select2" required></select>
                    @error('assign_to')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
