                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-12 fc-rtl">
                            ...
                            <button class="btn btn-sm btn-primary" id="filter-5day"><i class="fa fa-check mr-1" id="filter-5day-icon"></i> Show 5 Hari</button>
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-12 fc-rtl">
                            ...
                            <button class="btn btn-sm btn-outline-primary filter_mutation" id="filter-mandiri-mutation" data-id="mandiri">Mandiri</button>
                            ...
                            <div class="mt-1"></div>
                            <button class="btn btn-sm btn-outline-primary" id="filter-today-mutation"><i class="fa fa-filter mr-1" id="filter-1day-icon"></i> Today</button>
                            <button class="btn btn-sm btn-outline-primary" id="filter-1day-mutation"><i class="fa fa-filter mr-1" id="filter-1day-icon"></i> Kemarin</button>
                            <button class="btn btn-sm btn-primary" id="filter-5day"><i class="fa fa-check mr-1" id="filter-5day-mutation-icon"></i> 2 Hari</button>
