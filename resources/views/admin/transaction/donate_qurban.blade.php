@extends('layouts.admin', [
    'second_title'    => 'Transaksi Qurban',
    'header_title'    => 'Transaksi Donasi Qurban',
    'sidebar_menu'    => 'donate_qurban',
    'sidebar_submenu' => 'donate_qurban'
])
                        ...
                        <div class="col-12 fc-rtl ps-1 pe-1">
                            <div class="grid-menu grid-menu-2col">
                                <div class="no-gutters row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="widget-chart widget-chart-hover">
                                            <div class="widget-numbers text-warning fs-5">Kambing</div>
                                            <div class="widget-numbers text-dark fs-5">
                                                <span id="">{{ number_format($donate_kambing_paid_sum) }}</span>
                                            </div>
                                            <div class="widget-subheading">
                                                Jumlah: <span id="">{{ number_format($donate_kambing_count) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="widget-chart widget-chart-hover">
                                            <div class="widget-numbers text-info fs-5">Domba</div>
                                            <div class="widget-numbers text-dark fs-5">
                                                <span id="">{{ number_format($donate_domba_paid_sum) }}</span>
                                            </div>
                                            <div class="widget-subheading">
                                                Jumlah: <span id="">{{ number_format($donate_domba_paid_count) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="widget-chart widget-chart-hover">
                                            <div class="widget-numbers text-primary fs-5">Sapi 1/7</div>
                                            <div class="widget-numbers text-dark fs-5">
                                                <span id="">{{ number_format($donate_sapi17_paid_sum) }}</span>
                                            </div>
                                            <div class="widget-subheading">
                                                Jumlah: <span id="">{{ number_format($donate_sapi17_paid_count) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="widget-chart widget-chart-hover">
                                            <div class="widget-numbers text-warning fs-5">Sapi</div>
                                            <div class="widget-numbers text-dark fs-5">
                                                <span id="">{{ number_format($donate_sapi_paid_sum) }}</span>
                                            </div>
                                            <div class="widget-subheading">
                                                Jumlah: <span id="">{{ number_format($donate_sapi_paid_count) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="widget-chart widget-chart-hover">
                                            <div class="widget-numbers text-primary fs-5">TOTAL PAID</div>
                                            <div class="widget-numbers text-dark fs-5">
                                                <span id="">{{ number_format($donate_total_paid_sum) }}</span>
                                            </div>
                                            <div class="widget-subheading">
                                                Jumlah: <span id="">{{ number_format($donate_total_paid_count) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-12 fc-rtl">
                            ...
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-bca" data-id="bca">BCA</button>
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-bni" data-id="bni">BNI</button>
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-bsi" data-id="bsi">BSI</button>
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-bri" data-id="bri">BRI</button>
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-qris" data-id="qris">QRIS</button>
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-gopay" data-id="gopay">Gopay</button>
                            <button class="btn btn-sm btn-outline-primary filter_payment" id="filter-mandiri" data-id="mandiri">Mandiri</button>
                            <div class="mt-1"></div>
                            <button class="btn btn-sm btn-outline-primary" id="filter-fu"><i class="fa fa-filter mr-1" id="filter-fu-icon"></i> Butuh FU</button>
                            <button class="btn btn-sm btn-outline-primary" id="filter-1day"><i class="fa fa-filter mr-1" id="filter-1day-icon"></i> Show Kemarin</button>
                            <button class="btn btn-sm btn-outline-primary" id="filter-5day"><i class="fa fa-filter mr-1" id="filter-5day-icon"></i> Show 5 Hari</button>
...
<script type="text/javascript">    
    ...
    function mutation_table() {
        ...
        table_mutation.ajax.url("{{ route('adm.donate.mutation.datatables') }}/?today="+mut_today+"&day1="+mut_day1+"&day2="+mut_day2+"&notmatch="+mut_notmatch+"&bca="+mut_bca+"&bni="+mut_bni+"&bsi="+mut_bsi+"&bri="+mut_bri+"&mandiri="+mut_mandiri+"&filter_nominal="+mut_nominal).load();
    }
    ...
    function donate_table() {
        ...
        table.ajax.url("{{ route('adm.donate.qurban.datatables') }}/?need_fu="+need_fu_ar+"&day1="+day1_ar+"&day5="+day5_ar+"&bca="+bca_ar+"&bni="+bni_ar+"&bsi="+bsi_ar+"&bri="+bri_ar+"&qris="+qris_ar+"&gopay="+gopay_ar+"&mandiri="+mandiri_ar+"&donatur_name="+encodeURI(donatur_name)+"&donatur_telp="+donatur_telp+"&filter_nominal="+filter_nominal+"&donatur_title="+encodeURI(donatur_title)).load();
    }
    ...
    var table = $('#table-donatur').DataTable({
        ...
        ajax: "{{ route('adm.donate.qurban.datatables') }}/?need_fu="+need_fu+"&day1="+day1+"&day5="+day5,
        "columnDefs": [
            { "width": "32%", "targets": 0 },
            { "width": "15%", "targets": 1 },
            { "width": "23%", "targets": 2 },
        ...
        columns: [
            ...
            {data: 'qurban_type', name: 'qurban_type'},
