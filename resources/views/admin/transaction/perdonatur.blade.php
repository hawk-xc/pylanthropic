@extends('layouts.admin', [
    ...
    'header_title'    => 'Donasi '.ucwords($donatur->name),
    'sidebar_menu'    => 'donate',
                ...
                <div class="col-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 pb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ ucwords($donatur->name) }}</li>
                        </ol>
                    </nav>
                </div>
...
<script type="text/javascript">    
    ...
    var table = $('#table-donatur').DataTable({
        ...
        responsive: true,
        order: [[4, 'desc']],
        ajax: "{{ route('adm.donate.donatur.datatables', $donatur->id) }}",
        columns: [
