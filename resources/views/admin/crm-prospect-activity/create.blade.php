@extends('layouts.admin', [
    'second_title' => 'Aktifitas CRM Prospect',
    'header_title' => 'Aktifitas CRM Prospect',
...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 pb-0 pl-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="{{ route('adm.program.index') }}">CRM Pipeline</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Prospect Activity</li>
                        </ol>
                    </nav>
                </div>
            ...
            <form action="{{ route('adm.crm-prospect-activity.store') }}" method="post" accept-charset="utf-8" class="row gy-3">
                @csrf
                <div class="col-12">
                    <label class="form-label">Pipeline</label>

                    @php
                        $isDisabled = request()->query('type') !== null;
                        $selectedPipelineId = $pipelines->firstWhere('type', request()->query('type'))?->id;
                    @endphp
                    ...
                    <select class="form-control" name="pipeline" id="pipeline" required
                        ...
                        @forelse ($pipelines as $pipeline)
                            <option value="{{ $pipeline->id }}"
                                {{ request()->query('type') === $pipeline->type ? 'selected' : '' }}>
                                {{ $pipeline->type }}
                            </option>
                        @empty
                    ...
                    @if ($isDisabled)
                        <input type="hidden" name="pipeline" value="{{ $selectedPipelineId }}">
                    @endif
                ...
                <div class="col-12">
                    ...
                    <select class="form-control form-control-sm" name="type" id="type-select" required>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="content" name="content" rows="3" placeholder="Masukkan Konten">{{ old('content') }}</textarea>
                </div>
                ...
                <div class="col-12">
                    <label for="date" class="form-label required">Tanggal dan Jam</label>
