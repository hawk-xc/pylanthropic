    ...
    <div class="custom-container">
      ...
      <div class="mt-2 row d-flex align-content-center text-center">
        ...
        <a href="#kabar-terbaru" class="col-4 btn-donate-detail2">
          <div>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img">
                <path d="M17.354 21H18a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3h-.646A4.482 4.482 0 0 1 18.5 6v12a4.484 4.484 0 0 1-1.146 3Z" fill="#3BA8DD"></path>
        ...
        <a href="#penggunaan-dana" class="col-4 btn-donate-detail3">
          <div>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" class="mt-0.5">
                <path d="M21 13.65a1 1 0 1 0-2 0v2a2 2 0 0 1-2 2h-5.5l.6-.45a1 1 0 1 0-1.2-1.6l-3 2.25a1 1 0 0 0 0 1.6l3 2.25a1 1 0 0 0 1.2-1.6l-.6-.45H17a4 4 0 0 0 4-4v-2Z" fill="#3BA8DD"></path>
  ...
  <section class="py-20">
    <div class="custom-container">
      ...
      <div class="alert alert-secondary disclaimer-detail mt-3 mb-2">
        <strong class="">Disclaimer :</strong> Informasi, opini dan foto yang ada di halaman program ini adalah milik dan tanggung jawab penggalang dana dan tidak mewakili Bantubersama.com. Jika ada masalah/kecurigaan silahkan <a href="https://wa.me/628155555849" target="_blank">lapor kepada kami disini</a>
      </div>
  ...
  <section class="py-20">
    <div class="custom-container">
      ...
      @else
        ...
        <div class="row mb-3">
          <div class="col-12">
            <div class="text-center fs-14 lh-20 text-muted">Jadikan Anda sebagai pelopor orang baik untuk program ini</div>
          </div>
        </div>
      @endif
    </div>
