...
@section('content')
    ...
    <section class="pt-3">
        <div class="custom-container">
            ...
            <div class="progress mt-2" role="progressbar" aria-label="Basic example" aria-valuenow="89" aria-valuemin="0"
                aria-valuemax="100" style="height: 5px">
                <div class="progress-bar" it="{{ $sum_amount }}"
                ...
                <div class="ms-2">
                    ...
                    <div class="verified-fundraiser d-inline-block mt-1">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="fs-11 ms-1 ps-1">
                                @if ($program->status == 'verified' || $program->status == 'verif_org')
                                    Akun Terverifikasi
                                @endif
                            </div>
                        </div>
        ...
        <div class="custom-container">
            ...
            <div class="content-preview" id="preview-about">
                <div class="content-mini fs-15 text-center">
                    ...
                    <table style="border: none; text-align: left; color: #212529; font-size: 12px;" cellpadding="40">
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                            <td>Yayasan Bantu Beramal Bersama</td>
                        </tr>
                        <tr>
                            <td>Izin KEMENKUMHAM</td>
                            <td>:</td>
                            <td>AHU-0009568.AH.01.04.Tahun 2024</td>
                        </tr>
                        <tr>
                            <td style="padding-right: 8px;">Izin Kemenkeu (NPWP)</td>
                            <td style="padding-right: 8px;">:</td>
                            <td>19.875.390.7-542.000</td>
                        </tr>
                        <tr>
                            <td>Izin NIB</td>
                            <td>:</td>
                        ...
                        <li>
                            <div class="info-head">
                                <div class="info-box justify-content-start">
                                    <div class="img-wrap">
                                        <img class="lazyload"
                                            data-original="{{ asset('public/images/fundraiser/' . $program->logo) }}"
                                            alt="{{ $program->name }}" />
                                    </div>
                                    <div class="pt-1">
                                        ...
                                        <div class="content-donatur">
                                            <div class="">
                                                <div class="fs-14 fw-semibold">
                                                    {{ $vd->is_show_name == 1 ? $vd->name : 'Orang Baik' }}</div>
                                                <div class="fs-13">{{ $vd->date_string }}</div>
                                            </div>
                                            <div class="fs-14 fw-semibold">Rp
                                                {{ str_replace(',', '.', number_format($vd->nominal_final)) }}</div>
                                        </div>
