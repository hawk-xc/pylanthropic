...
@section('content')
    ...
    <section class="payment method section-lg-b-space pt-0">
        ...
        @else
            <h5 class="fw-medium fs-15 mt-4" id="desc_title">Selangkah lagi selesaikan Qurban Anda</h5>
        @endif
        ...
        <div class="d-flex align-items-center mt-2 pt-1">
            ...
            <div class="text3">
              <div class="text-title">Rp {{ str_replace(',', '.', number_format($price)) }}</div>
              <div class="text-desc text-end">Jumlah <b>1</b></div>
            </div>
        </div>
      ...
      <ul class="payment-list">
        ...
        @if($payment->type=='transfer' || $payment->key=='qris')
          <div class="fs-15 fw-medium my-3">Total Harga Qurban</div>
            ...
            <div class="w-100">
              <div class="payment-detail">
                <div class="d-flex justify-content-between align-items-center w-100">
                  <div class="fs-16">Total Harga Qurban</div>
                  <h5 class="fw-semibold fs-18">{{ trim($nominal_show) }}<span class="highlight-digit">{{ $nominal_show2 }}</span></h5>
                </div>
              </div>
            </div>
  ...
  <div class="offcanvas offcanvas-bottom addtohome-popup theme-offcanvas rounded-top-8" tabindex="-1" id="offcanvas">
    <div class="offcanvas-body text-center rounded-top-8">
      ...
      <div class="d-flex flex-wrap">
        ...
        <button title="" type="button" class="btn-icon-share" data-clipboard-text="{{ url('/') }}">
  ...
  <script type="text/javascript">
    ...
    $(".btn-icon-share").on("click", function() {
      ...
      if(name=='facebook'){
        ...
        let url = encodeURI('https://telegram.me/share/url?url='+uri+'&text={{ $title }}');
        window.open(url, 'name', 'width=600,height=400');
      } else if(name=='line') {
