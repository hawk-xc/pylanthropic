...
@section('css_plugins')
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id={{ $pixel_id }}&ev=InitiateCheckout&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
    ...
    @if (false)
        ...
        <script>
            ! function(w, d, t) {
                w.TiktokAnalyticsObject = t;
                var ttq2 = w[t] = w[t] || [];
                ttq2.methods = ["page", "track", "identify", "instances", "debug", "on", "off", "once", "ready", "alias",
                    "group", "enableCookie", "disableCookie", "holdConsent", "revokeConsent", "grantConsent"
                ], ttq2.setAndDefer = function(t, e) {
                    t[e] = function() {
                        t.push([e].concat(Array.prototype.slice.call(arguments, 0)))
                    }
                };
                for (var i = 0; i < ttq2.methods.length; i++) ttq2.setAndDefer(ttq2, ttq2.methods[i]);
                ttq2.instance = function(t) {
                    for (
                        var e = ttq2._i[t] || [], n = 0; n < ttq2.methods.length; n++) ttq2.setAndDefer(e, ttq2.methods[n]);
                    return e
                }, ttq2.load = function(e, n) {
                    var r = "https://analytics.tiktok.com/i18n/pixel/events.js",
                        o = n && n.partner;
                    ttq2._i = ttq2._i || {}, ttq2._i[e] = [], ttq2._i[e]._u = r, ttq2._t = ttq2._t || {}, ttq2._t[e] = +
                        new Date, ttq2._o = ttq2._o || {}, ttq2._o[e] = n || {};
                    n = document.createElement("script");
                    n.type = "text/javascript", n.async = !0, n.src = r + "?sdkid=" + e + "&lib=" + t;
                    e = document.getElementsByTagName("script")[0];
                    e.parentNode.insertBefore(n, e)
    ...
    @if (false)
        ...
        <script>
            ! function(w, d, t) {
                w.TiktokAnalyticsObject = t;
                var ttq3 = w[t] = w[t] || [];
                ttq3.methods = ["page", "track", "identify", "instances", "debug", "on", "off", "once", "ready", "alias",
                    "group", "enableCookie", "disableCookie", "holdConsent", "revokeConsent", "grantConsent"
                ], ttq3.setAndDefer = function(t, e) {
                    t[e] = function() {
                        t.push([e].concat(Array.prototype.slice.call(arguments, 0)))
                    }
                };
                for (var i = 0; i < ttq3.methods.length; i++) ttq3.setAndDefer(ttq3, ttq3.methods[i]);
                ttq3.instance = function(t) {
                    for (
                        var e = ttq3._i[t] || [], n = 0; n < ttq3.methods.length; n++) ttq3.setAndDefer(e, ttq3.methods[n]);
                    return e
                }, ttq3.load = function(e, n) {
                    var r = "https://analytics.tiktok.com/i18n/pixel/events.js",
                        o = n && n.partner;
                    ttq3._i = ttq3._i || {}, ttq3._i[e] = [], ttq3._i[e]._u = r, ttq3._t = ttq3._t || {}, ttq3._t[e] = +
                        new Date, ttq3._o = ttq3._o || {}, ttq3._o[e] = n || {};
                    n = document.createElement("script");
                    n.type = "text/javascript", n.async = !0, n.src = r + "?sdkid=" + e + "&lib=" + t;
                    e = document.getElementsByTagName("script")[0];
                    e.parentNode.insertBefore(n, e)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            const ipField = document.querySelector('#ip_field');
            if (!ipField) return;
...
@section('content')
    ...
    <form method="post" action="{{ route('donate.payment_info', $program->slug) . $uri_param }}">
        ...
        <input type="hidden" name="public_ip" id="ip_field">
        ...
        <section class="payment method section-lg-b-space pt-0">
            <div class="custom-container">
                ...
                <div class="d-flex align-items-center mt-2 pt-1">
                    ...
                    <input class="form-nominal-other fs-18 fw-bold" name="nominal" placeholder="0" type="text"
                        value="{{ number_format($nominal) }}" readonly required />
                    <input type="hidden" name="type" value="{{ $payment->key }}" required>
                    <input type="hidden" name="slug" value="{{ $program->slug }}" required>
                </div>
                <input type="text" name="payment_method_check" style="display:none !important" tabindex="-1"
                    autocomplete="off">
                    ...
                    <li class="cart-add-box payment-card-box gap-0 mt-2">
                        <div class="w-100">
                            <div class="payment-detail">
                                <div class="add-img">
                                    <img class="img" src="{{ asset('public/images/payment/' . $payment->img) }}"
                                        alt="{{ $payment->name }}" />
                                </div>
                                ...
                                <a href="{{ route('donate.payment', ['slug' => $program->slug, 'nominal' => $nominal]) }}"
                                    class="fw-semibold color-me">Ganti</a>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <div class="form-input mt-4">
                    <input type="text" name="fullname" class="form-control fs-14 form-payment"
                        value="{{ request('name') ?? '' }}" placeholder="Nama Lengkap" required />
                    @error('fullname')
                ...
                <div class="form-input mt-2">
                    <input type="text" name="telp" class="form-control fs-14 form-payment"
                        value="{{ request('telp') ?? '' }}" placeholder="Nomor Telpon : 08....." required />
                    @error('telp')
                        <div class="alert alert-secodary disclaimer-detail mb-1" style="color: #c91616ff;">
                            <strong class="">Perhatikan!</strong> {{ $message }}
                        </div>
                ...
                <div class="form-input">
                    <label class="fw-medium fs-15 mb-1 pb-1">Tulis pesan dan do'a <span
                            class="text-muted">(opsional)</span></label>
                    <textarea name="doa" rows="5" class="form-control fs-14 lh-20 form-payment"
                        placeholder="Tulis pesan dan do'a  untuk diri sendiri atau penggalang dana agar dilihat dan diamini oleh orang baik lainnya"></textarea>
                </div>
                ...
                <div class="alert alert-secondary disclaimer-detail mt-4">
                    Nominal di atas sudah termasuk 5% donasi operasional Bantubersama. Jika nominal donasi tidak sesuai
                    dengan angka unik yang tertera maka kami catat sebagai akad infak umum.
                </div>
